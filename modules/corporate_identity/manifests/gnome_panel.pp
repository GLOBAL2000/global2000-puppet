...
class gnome_panel::karmic inherits gnome_panel::common {
  ...
  file {
    ["/usr/share/icons/Humanity/places/16/start-here.svg",
     ...
     "/usr/share/icons/Humanity/places/32/start-here.svg",
...
class gnome_panel::lucid inherits gnome_panel::common {
}
